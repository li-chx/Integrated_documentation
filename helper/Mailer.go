...
func getHtmlContentc(MsgType int, DesireContent string, MessageContent string) string {
...
func SendMailc(EmailAddress string, MsgType int, DesireContent string, MessageContent string) error {

	mailConfig := config.GetMailConfig()
	html := getHtmlContentc(MsgType, DesireContent, MessageContent)
